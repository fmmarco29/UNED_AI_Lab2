# Aplicaciones de IA en Desarrollo Humano
...
- **Nombre**: Aplicaciones de IA en Desarrollo Humano
- **Créditos**: 6 ECTS
- **Descripción**: IA aplicada a salud, educación y bienestar social

## 📁 Estructura

```
12_Aplicaciones_IA_Desarrollo_Humano/
├── src/           # Código fuente
