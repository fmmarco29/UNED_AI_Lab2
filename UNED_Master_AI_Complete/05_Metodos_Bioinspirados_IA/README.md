...
- **Nombre**: Métodos Bioinspirados en IA
- **Créditos**: 6 ECTS
- **Descripción**: Algoritmos genéticos, redes neuronales y computación evolutiva

## 📁 Estructura

```
05_Metodos_Bioinspirados_IA/
├── src/           # Código fuente
