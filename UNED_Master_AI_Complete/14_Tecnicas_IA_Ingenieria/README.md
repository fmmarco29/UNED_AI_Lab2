...
- **Nombre**: Técnicas de IA en Ingeniería
- **Créditos**: 6 ECTS
- **Descripción**: Optimización, robótica y sistemas embebidos inteligentes

## 📁 Estructura

```
14_Tecnicas_IA_Ingenieria/
├── src/           # Código fuente
