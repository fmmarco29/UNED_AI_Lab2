...
- **Nombre**: Métodos Probabilistas en IA
- **Créditos**: 6 ECTS
- **Descripción**: Redes bayesianas, cadenas de Markov y métodos estocásticos

## 📁 Estructura

```
03_Metodos_Probabilistas_IA/
├── src/           # Código fuente
