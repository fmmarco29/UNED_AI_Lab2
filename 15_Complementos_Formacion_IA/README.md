# Complementos de Formación en IA
...
- **Nombre**: Complementos de Formación en IA
- **Créditos**: 6 ECTS
- **Descripción**: Temas avanzados y tendencias emergentes en IA

## 📁 Estructura

```
15_Complementos_Formacion_IA/
├── src/           # Código fuente
